...
**For Confluence pages:**
```
**Source:** [Page Title](https://example.atlassian.net/wiki/spaces/SPACE/pages/123456)
```

**For Jira issues:**
```
**Related Tickets:**
- [PROJ-123](https://example.atlassian.net/browse/PROJ-123) - Brief description
- [PROJ-456](https://example.atlassian.net/browse/PROJ-456) - Brief description
```
...
- [Minion Configuration](https://example.atlassian.net/wiki/spaces/DEVOPS/pages/67890)

**Jira Issues:**
- [PROJ-145](https://example.atlassian.net/browse/PROJ-145) - Minion scaling implementation
- [PROJ-203](https://example.atlassian.net/browse/PROJ-203) - Performance optimization
