...
## Resources
- API Spec: https://example.atlassian.net/wiki/API-Design
...
## Resources
- Bug Report: https://example.atlassian.net/wiki/BUG-456
...
## Resources
- Migration RFC: https://example.atlassian.net/wiki/PG15-Migration
