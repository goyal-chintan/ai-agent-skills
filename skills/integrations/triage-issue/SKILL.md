...
Status: Resolved | Fixed: 2 weeks ago | Fixed by: @eve.smith
https://example.atlassian.net/browse/PROJ-789

**2. PROJ-234** - Login timeout on slow connections
Status: Open | Priority: Medium | Created: 1 month ago
https://example.atlassian.net/browse/PROJ-234
...
**Next Steps:**
- The assignee (@dave.doe) will be notified
...
https://example.atlassian.net/browse/PROJ-890
...
Status: Resolved (Fixed) | Fixed: 3 months ago | Fixed by: @eve.smith
Resolution: [Brief description of fix]
https://example.atlassian.net/browse/PROJ-567
...
https://example.atlassian.net/browse/PROJ-891
